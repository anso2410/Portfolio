...
// ******** GreenSock menu  gauche item  GSAP ********************* 

window.onload = function () {


    let image = document.getElementsByClassName('span');
     // console.log(image);
   
     TweenMax.staggerFrom(('span'), 1, {
         y:-500,
         opacity:0
   
     }, 0.5)

     TweenMax.from(['.img1', '.img2' ], 1,{
            x: -500,
            opacity: 0,             delay:1
                   })
}
 ...
 // ************* Animation écriture Typewriter Accueil *********************       
 ...
 .pauseFor(1200)
 .deleteChars(24)
 .typeString('<span style = "color: #27ae60;"><strong> CSS Lover</></span> ')
 .pauseFor(1200)
 
 .deleteChars(12)
 .typeString('<span style="color: #EA39ff;"><strong> PhP Beginner</></span> ')
 .pauseFor(1200)
 .deleteChars(14)
 .typeString('<span style="color: blue;"><strong> React JS</></span> ')
 .pauseFor(1200)
 .deleteChars(11)
 .typeString('<span style="color: #ff6910;"><strong> JavaScript</></span> ')
 .pauseFor(1200)
 .start()
...
tlPortfolio
.from(titrePortfolio, {y: -50, opacity: 0, duration: 1})
